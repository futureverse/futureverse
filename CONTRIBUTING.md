# Contributing to the ‘futureverse’ package
...
[`develop`](https://github.com/futureverse/futureverse/tree/develop)
branch contains the latest contributions and other code that will appear
in the next release, and the
[`master`](https://github.com/futureverse/futureverse) branch contains
the code of the latest release, which is exactly what is currently on
[CRAN](https://cran.r-project.org/package=futureverse).
...
[futureverse repository](https://github.com/futureverse/futureverse).
Your PR should pass `R CMD check --as-cran`, which will also be checked
by and when the PR is submitted.
